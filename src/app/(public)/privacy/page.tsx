...
export const metadata = {
  title: 'Privacy Policy | RapidScreen Platform',
  description: 'Privacy Policy for RapidScreen healthcare screening platform',
};
  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          RapidScreen Platform ("we," "our," or "us") is committed to protecting your privacy
      ...
      <section>
        ...
        <ul>
          ...
          <li><strong>Mail:</strong> RapidScreen Platform, Privacy Officer, [Address]</li>
        </ul>
