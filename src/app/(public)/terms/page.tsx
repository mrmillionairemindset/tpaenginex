...
export const metadata = {
  title: 'Terms of Service | RapidScreen Platform',
  description: 'Terms of Service for RapidScreen healthcare screening platform',
};
...
export default function TermsOfServicePage() {
  return (
    <ComplianceLayout
      ...
      description="Legal terms governing your use of the RapidScreen Platform"
    >
      <section>
        <h2>1. Acceptance of Terms</h2>
        <p>
          By accessing or using the RapidScreen Platform ("Platform"), you agree to be bound
          by these Terms of Service ("Terms"). If you do not agree to these Terms, you may
          not use the Platform.
        </p>
        <p>
          These Terms constitute a legally binding agreement between you and RapidScreen
          Platform ("RapidScreen," "we," "our," or "us").
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          RapidScreen provides a healthcare screening coordination platform that:
        </p>
        <ul>
        ...
        <p>
          RapidScreen acts as a technology platform and coordinator. We do not directly
      ...
      <section>
        ...
        <h3>8.1 RapidScreen IP</h3>
        <p>
          The Platform, including all content, features, and functionality, is owned by
          RapidScreen and protected by copyright, trademark, and other intellectual
          property laws.
        </p>
        ...
        <h3>8.3 Feedback</h3>
        <p>
          Any feedback, suggestions, or ideas you provide may be used by RapidScreen
      ...
      <section>
        ...
        <p>
          RapidScreen does not warrant that the Platform will meet your requirements or
      ...
      <section>
        ...
        <p>
          You agree to indemnify and hold harmless RapidScreen from any claims, damages,
      ...
      <section>
        ...
        <p>
          ...
          constitute the entire agreement between you and RapidScreen.
        </p>
      ...
      <section>
        ...
        <ul>
          ...
          <li><strong>Mail:</strong> RapidScreen Platform, Legal Department, [Address]</li>
        </ul>
      </section>
    </ComplianceLayout>
  );
